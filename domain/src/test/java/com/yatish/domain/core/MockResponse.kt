package com.yatish.domain.core

import com.google.gson.Gson

object MockResponse {
    fun getMockCoins(): List<com.yatish.domain.model.Coin> {
        val jsonString =
                    "{\n" +
                    "\"id\": \"btc-bitcoin\",\n" +
                    "\"name\": \"Bitcoin\",\n" +
                    ...
                    "\"type\": \"coin\"\n" +
                    "}\n"
        val coin = Gson().fromJson(jsonString, com.yatish.domain.model.Coin::class.java)
        return listOf(coin)
    }

    fun getMockCoinDetails(): com.yatish.domain.model.CoinDetail {
        val jsonString =
            "{\n" +
                    "  \"id\": \"btc-bitcoin\",\n" +
                    "  \"name\": \"Bitcoin\",\n" +
                    ...
                    "}"
        return Gson().fromJson(jsonString, com.yatish.domain.model.CoinDetail::class.java)
    }
}
